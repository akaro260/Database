              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jurursan
                    </th>
                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NISN
                    </th>
                ...
                foreach ($data as $mom): ?>
                  <tbody>
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0 px-3 py-1 d-flex flex-column justify-content-center">
                          <?php echo $no++; ?>
                        </p>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <a href="edit_siswa.php?id=<?php echo $mom['id_siswa']; ?>" class="btn btn-sm btn-warning">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="hapus_siswa.php?id=<?php echo $mom['id_siswa']; ?>" class="btn btn-sm btn-danger"
                          onclick="hapusSiswa(event, <?php echo $mom['id_siswa']; ?>)">
