                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle text-center pt-4">
                        ...
                        <a href="hapusadmin.php?id=<?php echo $mom['id_admin']; ?>" class="btn btn-sm btn-danger"
                          onclick="hapusAdmin(event, <?php echo $mom['id_admin']; ?>)">
...
<script>
function hapusAdmin(e, id) {
  e.preventDefault(); // stop link dulu
  ...
  setTimeout(() => {
     window.location.href = 'hapusadmin.php?id=' + id;
  }, 2000);
}
      ...
      Swal.fire({
        icon: 'info',
        title: 'Dibatalkan',
        text: 'Data admin tidak jadi dihapus',
        timer: 1500,
        showConfirmButton: false
      });
    }
