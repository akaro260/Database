              ...
              <div class="row">
                <div class="col-8 text-start">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                    <i class="fa-solid fa-graduation-cap circle-08 text-dark text-gradient text-lg opacity-10 mt-1"
                      aria-hidden="true"></i>
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-8 text-start">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                    <i class="fa-solid fa-user-tie circle-08 text-dark text-gradient text-lg opacity-10 mt-1"
                      aria-hidden="true"></i>
                  </div>
                  <?php ?>
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-8 text-start">
                  ...
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
                    <?php $query = mysqli_query($koneksi, "SELECT COUNT(id_siswa) AS jumlah_calon FROM tbl_voting;");
                    $row = mysqli_fetch_array($query);
                    echo $row['jumlah_calon'];
                    ?>
                  </h5>
                  <span class="text-white text-sm">Jumlah Vote dari siswa</span>
                </div>
                <div class="col-4">
                  <div class="dropdown text-end mb-6">
            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-8 text-start">
                  ...
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
                    <?php
                    $query = mysqli_query($koneksi, "SELECT tbl_calon_ketua.nama_calon, COUNT(tbl_voting.id_calon) AS jumlah 
  FROM tbl_calon_ketua 
  INNER JOIN tbl_voting ON tbl_voting.id_calon = tbl_calon_ketua.id_calon 
    ...
    <div class="col-lg-6 col-12 mt-4 mt-lg-0">
      <div class="card shadow h-100">
        <div class="card-header pb-0 p-3">
          <h3 class="text-center">Laporan Vote Ketua OSIS</h3>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-7">
              ...
              <p class="text-sm mb-0">
                ...
                <span class="font-weight-bold ms-1">SMK</span> Informatika Pesat
              </p>
            </div>
            ...
            <div class="row justify-content-center">
              ...
              while ($data = mysqli_fetch_assoc($calon)) {
                ...
                <div class="col-md-4 mb-3 text-center">
                  <img src="../../assets/img/<?= htmlspecialchars($data['foto']); ?>" class="img-fluid rounded"
                    style="height:250px; object-fit:cover;" alt="<?= htmlspecialchars($data['nama_calon']); ?>">

                  <p class="mt-2"><?= htmlspecialchars($data['nama_calon']); ?></p>
                </div>
        ...
        <div class="card-body p-3">
          <div class="timeline timeline-one-side">
            ...
            <div class="timeline-block mb-3">
              ...
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Pemilihan</h6>
            ...
            <div class="timeline-block mb-3">
              ...
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Pengumuman</h6>
            ...
            <div class="timeline-block">
              ...
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Pengukuhan</h6>
